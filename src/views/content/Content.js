          ...
          <div className="row">
            <div className="col-lg-9 col-md-9 col-sm-9 col-xs-12">
              <div className="product-sales-chart">
                ...
                <div id="curved-line-chart" className="flot-chart-sts flot-chart curved-chart-statistic" />
              </div>
            </div>
            <div className="col-lg-3 col-md-3 col-sm-3 col-xs-12">
              <div className="white-box analytics-info-cs mg-b-30 res-mg-t-30">
                ...
                <ul className="list-inline two-part-sp">
                  ...
                  <li className="text-right sp-cn-r"><i className="fa fa-level-up" aria-hidden="true" /> <span className="counter sales-sts-ctn">8659</span></li>
                </ul>
              </div>
              <div className="white-box analytics-info-cs mg-b-30">
                ...
                <ul className="list-inline two-part-sp">
                  ...
                  <li className="text-right"><i className="fa fa-level-up" aria-hidden="true" /> <span className="counter sales-sts-ctn">7469</span></li>
                </ul>
              </div>
              <div className="white-box analytics-info-cs mg-b-30">
                ...
                <ul className="list-inline two-part-sp">
                  ...
                  <li className="text-right"><i className="fa fa-level-up" aria-hidden="true" /> <span className="counter sales-sts-ctn">6011</span></li>
                </ul>
              </div>
              <div className="white-box analytics-info-cs">
                ...
                <ul className="list-inline two-part-sp">
                  ...
                  <li className="text-right"><i className="fa fa-level-down" aria-hidden="true" /> <span className="sales-sts-ctn">18%</span></li>
                </ul>
              </div>
            </div>
          </div>
