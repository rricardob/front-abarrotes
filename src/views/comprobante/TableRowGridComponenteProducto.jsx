...
const TableRowGridComponenteProducto = ({ view, row, rowSelected, cancel }) => {
  ...
  return (
    <tr>
      ...
      <td className='text-center'>
        <label className={stateClassp}>
          {pestado === 0 ? "ACTIVO" : "INACTIVO"}
        </label>
      </td>
      <td className='text-center'>
...
export default TableRowGridComponenteProducto;
