                            ...
                            <div className="mobile-menu">
                                <nav id="dropdown">
                                    <ul className="mobile-menu-nav">
                                        ...
                                        <li><a data-toggle="collapse" data-target="#others" href="#">Miscellaneous <span className="admin-project-icon nalika-icon nalika-down-arrow" /></a>
                                        ...
                                        <li><a data-toggle="collapse" data-target="#Miscellaneousmob" href="#">Interface <span className="admin-project-icon nalika-icon nalika-down-arrow" /></a>
                                        ...
                                        <li><a data-toggle="collapse" data-target="#Chartsmob" href="#">Charts <span className="admin-project-icon nalika-icon nalika-down-arrow" /></a>
                                        ...
                                        <li><a data-toggle="collapse" data-target="#Tablesmob" href="#">Tables <span className="admin-project-icon nalika-icon nalika-down-arrow" /></a>
                                        ...
                                        <li><a data-toggle="collapse" data-target="#formsmob" href="#">Forms <span className="admin-project-icon nalika-icon nalika-down-arrow" /></a>
                                        ...
                                        <li><a data-toggle="collapse" data-target="#Appviewsmob" href="#">App views <span className="admin-project-icon nalika-icon nalika-down-arrow" /></a>
